...
class NewPasswordUpdatedScreen extends StatefulWidget {
  const NewPasswordUpdatedScreen({Key? key}) : super(key: key);

  @override
  _NewPasswordUpdatedScreenState createState() => _NewPasswordUpdatedScreenState();
}

class _NewPasswordUpdatedScreenState extends State<NewPasswordUpdatedScreen> {
  @override
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: SvgPicture.asset(
                    "assets/images/logo/done_icon.svg",
                    semanticsLabel: '',
                ...
                SizedBox(
                  ...
                  child: Text(
                    locale!.passwordUpdatedTitle, textAlign: TextAlign.center, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 16),),
                ),
                const SizedBox(height: 20),
                SizedBox(
                    width: MediaQuery.of(context).size.width * 0.8,
                    child: Text(locale.passwordUpdatedContent, textAlign: TextAlign.center, style: const TextStyle(color: AppColors.greyLight, fontWeight: FontWeight.w400, fontSize: 14),)),
