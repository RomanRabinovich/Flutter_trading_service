...
import 'package:tplatfom/models/currency.dart';
import 'package:tplatfom/models/trade.dart';
import 'package:tplatfom/presentation/features/currency_details_screen/components/currency_chart.dart';
import 'package:tplatfom/presentation/features/currency_details_screen/components/trade_button.dart';
import 'package:tplatfom/presentation/features/currency_details_screen/components/trade_item.dart';
import 'package:tplatfom/utils/global_variables.dart';

class CurrencyDetailsScreen extends StatelessWidget {
  final Currency currency;

  const CurrencyDetailsScreen({super.key, required this.currency});
